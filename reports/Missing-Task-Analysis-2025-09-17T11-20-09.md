...
**Generated:** 2025-09-17T11:20:09.419Z
...
| SOP Category | SOP Task | Task Code | Checklist Completed | Missing Checklist |
|--------------|----------|-----------|---------------------|-------------------|
| Pre-Visit | Appointment Scheduling | PV.1 | None | 1. Name & DOB verified<br>2. Contact confirmed<br>3. Visit type correct<br>4. Provider assigned<br>5. Slot scheduled (no double-booking)<br>6. Verbal confirmation<br>7. SMS/email sent<br>8. Prep instructions shared<br>9. Saved in EHR<br>10. New patient - verify insurance |
| Pre-Visit | Insurance Eligibility Verification | PV.2 | None | 1. Active insurance confirmed<br>2. Co-pay identified<br>3. Deductible status noted<br>4. PCP assignment validated<br>5. Issues flagged<br>6. Patient notified<br>7. Documented in EHR |
| Check-In | Patient Registration | CI.1 | 1. Arrival time logged<br>2. Patient marked "arrived" in system | 1. ID verified<br>2. DOB confirmed<br>3. Insurance card scanned<br>4. Demographics updated |
| Check-In | Co-Pay & Billing Collection | CI.2 | None | 1. Co-pay verified<br>2. Payment collected<br>3. Receipt issued<br>4. EHR updated<br>5. Deposit log reconciled |
| Check-In | Demographics Update | CI.3 | 1. Phone number confirmed<br>2. Pharmacy updated | 1. Address confirmed<br>2. Emergency contact verified<br>3. Communication preference updated |

### MA (Medical Assistant)

| SOP Category | SOP Task | Task Code | Checklist Completed | Missing Checklist |
|--------------|----------|-----------|---------------------|-------------------|
| Pre-Visit | Pre-Visit Planning (PVP) | PV.3 | None | 1. Chart reviewed<br>2. Past visits/labs reviewed<br>3. Care gaps identified<br>4. Abnormals flagged<br>5. PVP note entered |
...
| Pre-Provider Onsite Workflow | Chief Complaint Capture | PP.3 | 1. Chief complaint asked<br>2. Saved in EHR | 1. Patient words documented<br>2. Linked to visit type<br>3. Provider notified if urgent |
| Pre-Provider Onsite Workflow | Medication Reconciliation | PP.5 | 1. Medication list reviewed<br>2. Allergies documented | 1. Dose/frequency confirmed<br>2. Adherence checked<br>3. Side effects noted<br>4. Updates entered in portal<br>5. Discrepancies flagged |
...
| Pre-Provider Onsite Workflow | Rooming | PP.8 | 1. Patient called from lobby | 1. ID verified<br>2. Escorted to correct room<br>3. Comfort ensured<br>4. Orientation provided<br>5. Rooming status updated in EHR |

### CA/CM (Care Assistant/Care Manager)

| SOP Category | SOP Task | Task Code | Checklist Completed | Missing Checklist |
|--------------|----------|-----------|---------------------|-------------------|
| Pre-Provider Onsite Workflow | Patient Education (Condition Basics) | PP.1 | 1. Confirm patient condition | 1. Delivered script-based education<br>